        ...
        <div className="relative h-full max-w-6xl mx-auto flex flex-col justify-end pb-20 px-4">
          <div className="text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <Link href="/sensei">
                <Button size="lg" className="w-full sm:w-auto bg-[#3F3EED] border-[#3F3EED] text-white hover:bg-transparent hover:text-[#3F3EED]">
                  <Brain className="mr-2 h-5 w-5 group-hover:text-[#3F3EED]" />
                  Enter Sensei Mode
                </Button>
              </Link>
              <Link href="/learning-paths">
                <Button size="lg" variant="outline" className="w-full sm:w-auto border-[#3F3EED] text-[#3F3EED] hover:bg-transparent hover:text-[#3F3EED] dark:border-white dark:text-white dark:hover:bg-transparent">
                  <GraduationCap className="mr-2 h-5 w-5 group-hover:text-[#3F3EED]" />
                  Browse Courses
                </Button>
              </Link>
            </div>
